...
int main(int argc, char *argv[])
{
    ...
    int (*Farr[21])(void) = {lsdo, chdir, pwd, quit, mdir, creat_file, rm_dir, mysymlink, link, touch, myunlink, mychmod, menu, preopen, pfd, pre_close, my_read, my_cat, write_file, my_cp, my_mv};
    if(argc > 1)
        diskname = argv[1];
